...
async def reedme(e):
    await e.edit(
        ...
        "\n[ProjectJVGUserBot's README.md file](https://github.com/JulianSurya/ProjectBish/blob/master/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Repo](https://github.com/JulianSurya/ProjectBish) GitHub's page."
    )
